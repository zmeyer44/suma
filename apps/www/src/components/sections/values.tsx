import { Check, KeyRound, Radio, RefreshCw } from "lucide-react";
...
/**
 * The claims the sections above used to spend paragraphs on, kept to the line
 * each one is actually worth. The first carries a link because it is the only
 * one a reader can go and check for themselves.
 */
const VALUES = [
  { icon: GithubMark, label: "Free and open-source", href: REPO_URL },
  { icon: RefreshCw, label: "Signed in on every device" },
  { icon: KeyRound, label: "Your keys stay on this Mac" },
  { icon: Radio, label: "Open protocols, no lock-in" },
  { icon: Check, label: "No ads, no tracking" },
];
    ...
    <section id="values" className="scroll-mt-24 pt-24 sm:pt-32">
      <Shell>
        <SectionHead
          ...
          title={<>Open code, open protocols.</>}
          action={{ href: REPO_URL, label: "Read the code" }}
        />

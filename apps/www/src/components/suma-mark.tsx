 ...
 * off-centre next to the wordmark. Shared with the canvas that samples it into
 * the hero mosaic (`pixel-mosaic.tsx`), so the poster cannot drift from the
 * logo in the nav.
 */
 ...
 * disc rather than as strokes over it, so the mark holds its weight at 26px in
 * the nav and the hero's sampler can read it straight off the alpha channel.
 */
